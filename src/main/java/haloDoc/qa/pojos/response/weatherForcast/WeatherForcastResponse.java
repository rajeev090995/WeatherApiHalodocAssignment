...
* @param sunRise
*/
public WeatherForcastResponse(List<ConsolidatedWeather> consolidatedWeather, String time, String sunRise, String sunSet, String timezoneName, Parent parent, List<Source> sources, String title, String locationType, Integer woeid, String lattLong, String timezone) {
super();
